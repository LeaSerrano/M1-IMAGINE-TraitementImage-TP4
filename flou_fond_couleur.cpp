...
{
  char cNomImgLue[250], cNomImgLueBinaire[250], cNomImgEcrite[250];
  int nH, nW, nTaille;
  ...
  if (argc != 4) 
   ...
   sscanf (argv[2],"%s",cNomImgLueBinaire);
   sscanf (argv[3],"%s",cNomImgEcrite);

   OCTET *ImgIn, *ImgBinaire, *ImgOut;
   ...
   allocation_tableau(ImgBinaire, OCTET, nTaille);
